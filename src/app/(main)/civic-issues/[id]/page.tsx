...
import { MapPin, Clock, User, ThumbsUp, ChevronLeft, Map as MapIcon, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
            ...
            <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-gray-300 bg-white/5 px-4 py-2 rounded-lg border border-white/5 w-full sm:w-auto">
              ...
              <button 
                ...
                className={`flex items-center gap-2 px-6 py-2.5 rounded-xl font-medium transition-all ${upvoted ? 'bg-blue-600 text-white shadow-[0_0_15px_rgba(37,99,235,0.4)]' : 'bg-white/10 text-gray-300 hover:bg-white/20'}`}
              >
